...
1. In PyPI, configure a trusted publisher for the `mn-api` project. If the project does not exist yet, create a pending publisher for that exact project name.
